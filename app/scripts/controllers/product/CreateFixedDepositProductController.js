  ...
  mifosX.controllers = _.extend(module, {
    CreateFixedDepositProductController: function (scope, resourceFactory, location, dateFilter) {
      ...
      resourceFactory.fixedDepositProductResource.get({resourceType: 'template'}, function (data) {
       ...
       /* scope.formData.fixedDepositTypeId=scope.product.fixedDepositTypeOptions[0].id;
        scope.formData.fixedDepositFrequencyTypeId=scope.product.fixedDepositFrequencyTypeOptions[0].id;*/
...
/*console.log(chartName);*/
        /*this.formData.name= ""+ name + "-" + date + "-" + endDate ;*/
